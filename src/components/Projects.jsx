    ...
    <main>
      <div className='py-4 px-8 lg:px-24'>
        ...
        {projectsData.length > projectsLimit && !showAllProjects && (
          <div className='my-8 flex flex-col md:flex-row items-center justify-center w-full'>
            <div className='h-[1px] w-full md:w-auto px-8 bg-gray-600'></div>
            <button
              onClick={() => setShowAllProjects(true)}
              className='text-green-500 border border-green-500 font-semibold hover:text-green-600 px-16 text-center py-3 rounded-full'
            >
              Show All
            </button>
            <div className='h-[1px] w-full md:w-auto px-8 bg-gray-600'></div>

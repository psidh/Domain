...
export default function Links() {
  return (
    <div className="dynamic-glow-yellow p-5 flex flex-col items-center justify-center w-full lg:w-1/2 shadow-lg shadow-yellow-400 border border-yellow-700 bg-gradient-to-tl from-yellow-700 to-black rounded-xl min-h-full">

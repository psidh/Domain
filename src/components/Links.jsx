...
export default function Links() {
  return (
    <div className=" p-5 flex flex-col items-center justify-between w-full lg:w-1/2 border border-yellow-700 bg-gradient-to-br from-yellow-950/50 to-black rounded-xl min-h-full">

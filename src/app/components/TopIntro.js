    ...
    <main> 
      ...
      <section className="flex flex-col justify-center items-center pt-8 pb-4 px-4 lg:px-18">
        <h2 className="md:text-2xl text-4xl font-semibold mt-8">
          ...
          <div className="py-2 px-4 lg:px-18 md:text-center text-justify mt-2 mb-8">
          ...
          <button className="mt-8 mb-8 bg-green-600 hover:bg-green-700 text-white py-2 px-8 rounded-3xl">
